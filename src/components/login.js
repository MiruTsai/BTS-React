        ...
        if (this.state.status === "signIn") {
            loginZone = <div className="login">
                <div className="loginZone">
                    ...
                    <input type="text" id="signInEmail" name="email" placeholder="測試帳號：test@test.com" value={this.state.email} onChange={this.updateInput} />
                    <div className="text2">密碼</div>
                    <input type="password" id="signInPW" name="password" value={this.state.password} placeholder="測試密碼：123456" onChange={this.updateInput} />
