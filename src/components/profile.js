...
class Profile extends Component {
  ...
  render () {
    ...
    return (
      <>
        <Link to="/">
          <img src={"/../img/logo/" + groupName + ".PNG"} className="profileLogo" />
        </Link>
        ...
        <div className={proContainerClass}>
          ...
          <div className="profile">
            <div className="profileZone">
              ...
              <div className="profile-text">累計答對： {userInfo[groupName + "rightCounter"]}</div>
              <div className="profile-text">累計答錯： {userInfo[groupName + "wrongCounter"]}</div>
            </div>
          </div>
          <Chart
            width={"500px"}
            ...
            data={[
              ["Task", "Hours per Day"],
              ["答對",
                userInfo[groupName + "rightCounter"]
              ],
              ["答錯",
                userInfo[groupName + "wrongCounter"]
              ]
            ]}
            options={{
              title: "你的答題正確率",
